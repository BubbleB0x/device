...
const uint8_t Calendario_Logo_bits[] PROGMEM = {
  ,
};
const uint8_t Orologio_Logo_bits[] PROGMEM = {
  , 
...
void accendiDisplay()
{
  ...
  switch (numeroDisplay)
  {
    ...
    display.clear();
    display.setTextAlignment(TEXT_ALIGN_CENTER);
    display.drawXbm(45, 10, 40, 40, Orologio_Logo_bits);
    display.setFont(ArialMT_Plain_10);
    ...
    display.clear();
    display.setTextAlignment(TEXT_ALIGN_CENTER);
    display.drawXbm(45, 10, 40, 40, Calendario_Logo_bits);
    display.setFont(ArialMT_Plain_10);
...
void IRAM_ATTR settaggioDataOra()
{
  if(numeroDisplay == 3)
  {
    numeroDisplay = 6;
...
void setup() 
{
  ...
  pinMode(clockChange, INPUT_PULLUP);
  attachInterrupt(statoDisplay, controlloCambioDisplay, HIGH);
  attachInterrupt(clockChange, settaggioDataOra, HIGH);
  display.init();
